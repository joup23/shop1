				...
				<tbody>
					<tr class="dot_line">
						...
						<td><input type="text" name="_member_id" id="_member_id"
							size="20"  oninput="fn_overlapped()"/> <input type="hidden" name="member_id"
							id="member_id"/> <span id="chkMsg">아이디를 입력 해주세요.</span> <!-- <input type="button"
							id="btnOverlapped" value="중복체크" onClick="fn_overlapped()" /> --></td>
					</tr>
					<tr class="dot_line">
