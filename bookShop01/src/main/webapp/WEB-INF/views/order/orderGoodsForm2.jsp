				...
				<div class="col-md-72">
					<div class="p-3 p-lg-5 border">
						...
						<div class="form-group row">
							...
							<div class="col-md-12">
								<span class="select-holder"> <select name="tel1" id="tel1"
						...
						<div class="form-group">
							<input type="text" class="form-control" name="namujiAddress" id="namujiAddress"
								placeholder="상세 주소" value="${orderer.namujiAddress }">
						</div>
						...
						<input type="hidden" id="gift_wrapping" name="gift_wrapping" value="yes">
					</div>
				</div>
			</div>
			<div class="row margin-bottom">
