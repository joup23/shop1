						...
						<ul>
							<c:choose>
								<c:when test="${isLogOn==true and not empty memberInfo }">
									<li><a href="${contextPath}/member/logout.do" title="로그아웃"><span
											class="icon icon-user-times"></span></a></li>
							...
							<c:if test="${isLogOn==true and memberInfo.member_id =='admin' }">
								<li><a href="${contextPath}/admin/goods/adminGoodsMain.do"
	...
	<nav class="site-navigation text-right text-md-center"
		...
		<div class="container">
			<ul class="site-menu js-clone-nav d-none d-md-block">
				<li class="has-children"><a href="${contextPath}/main/main.do">도서</a>
					<ul class="dropdown">
