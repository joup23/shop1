			...
			<c:choose>
				<c:when test="${side_menu=='admin_mode' }">
					<ul class="list-unstyled mb-0">
						<li class="mb-1"><a href="${contextPath}/admin/goods/adminGoodsMain.do" class="d-flex"><span>상품 관리</span></a></li>
						<li class="mb-1"><a href="${contextPath}/admin/order/adminOrderMain.do" class="d-flex"><span>주문 관리</span> </a></li>
						<li class="mb-1"><a href="${contextPath}/admin/member/adminMemberMain.do" class="d-flex"><span>회원 관리</span> </a></li>
					</ul>
				...
				<c:when test="${side_menu=='my_page' }">
					<ul class="list-unstyled mb-0">
						<li class="mb-1"><a href="${contextPath}/mypage/listMyOrderHistory.do" class="d-flex"><span>주문
									내역/배송 조회</span></a></li>
						<li class="mb-1"><a href="${contextPath}/mypage/myDetailInfo.do" class="d-flex"><span>회원
									정보</span> </a></li>
